    ...
    def predict(
        ...
        with model.autocast_context:
            ...
            model_output_data = {
                ...
                'perceptual_predicted_latent_image': scaled_predicted_latent_image / vae_scaling_factor,
            ...
            if self.debug_mode:
                with torch.no_grad():
                    ...
                    # predicted image
                    predicted_latent_image = model_output_data['perceptual_predicted_latent_image']
